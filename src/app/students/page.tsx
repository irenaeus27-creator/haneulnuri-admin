          ...
          <div className="space-y-3">
            <details open className="overflow-hidden rounded-2xl border border-[#dbe5f1] bg-[#fbfdff]">
              ...
              <div className="grid gap-4 border-t border-[#e5edf7] bg-white p-5 xl:grid-cols-2">
                ...
                <label className="ui-label"><span>전화번호</span><input className="ui-input" value={form.phone} onChange={(e) => updateForm("phone", e.target.value)} inputMode="numeric" placeholder="01000000000" /><span className="text-[11px] font-medium text-[#7f91aa]">하이픈(-) 없이 숫자만 입력하세요.</span></label>
                ...
                <label className="ui-label"><span>비상 연락처</span><input className="ui-input" value={form.emergencyContactPhone} onChange={(e) => updateForm("emergencyContactPhone", e.target.value)} inputMode="numeric" placeholder="01000000000" /><span className="text-[11px] font-medium text-[#7f91aa]">하이픈(-) 없이 숫자만 입력하세요.</span></label>
